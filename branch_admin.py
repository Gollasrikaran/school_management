...
import pandas as pd
from branchadmin_overview import display_branchadmin_overview
...
def branch_admin_dashboard(branch_name):
    ...
    # Add Navigation Bar
    page = st.selectbox("Choose a page", ["Overview","Teachers", "Classes", "Students", "Subjects", "Chapters", "Topics"], key = f"branch_select_{branch_name}")

    if page == "Overview":
        display_branchadmin_overview(branch_name)
    elif page == "Teachers":
    ...
    if branch_name and page != "Overview":
